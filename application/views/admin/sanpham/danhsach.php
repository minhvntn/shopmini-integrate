    <div class="container top">
      ...
      <div class="page-header users-header">
        <h2>
          <?php echo ucfirst($this->uri->segment(2));?> 
          <a  href="<?php echo site_url("admin").'/'.$this->uri->segment(2); ?>/them" class="btn btn-success">Add a new</a>
        </h2>
      </div>
      ...
      <div class="row">
        <div class="span12 columns">
          <div class="well">
            ...
            echo form_open('admin/sanpham', $attributes);
          ...
          <table class="table table-striped table-bordered table-condensed">
            ...
            <tbody>
              ...
              foreach($products as $row)
              {
                ...
                echo '<td>'.$row['danhmuc_name'].'</td>';
                echo '<td class="crud-actions">
                  <a href="'.site_url("admin").'/sanpham/capnhat/'.$row['ItemID'].'" class="btn btn-info">view & edit</a>  
                  <a href="'.site_url("admin").'/sanpham/xoa/'.$row['ItemID'].'" class="btn btn-danger">delete</a>
                </td>';
                echo '</tr>';
              }
              ?>      
